        ...
        <div class="slide-testi">
          <div class="rounded d-flex flex-column" style="width: 100%; height: 320px; border: 1px solid #322DD2; padding: 18px">
            ...
            <div class="my-3 flex-1">
              viverra dolor nulla, odio sed orci nisi quis sapien odio nisi ultrices sit felis, gravida facilisis sit Vestibulum sed Vestibulum Sed facilisis tortor. sapien ipsum venenatis ex eu adipiscing porta volutpat faucibus urna.
            </div>
            <div class="d-flex align-items-center">
              <div class="me-2">
                <img src="{{ asset("photo_empty.png") }}" style="width: 45px; height: 45px" alt="user empty">
              </div>
              <div class="flex-1">
                Lorem Ipsum
              </div>
  ...
  <div class="row">
    @for ($i = 0; $i < 12; $i++)
      <div class="col-6 col-md-4 col-lg-3 mt-4">
        <img src="{{ asset("testimoni_1.png") }}" class="img-fluid" alt="testimoni">
      </div>
    @endfor
  </div>
