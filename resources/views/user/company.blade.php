...
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add">Tambah Gambar</button>
        <div class="w-full mt-3">
          <table id="table" class="table">
            <thead>
              <tr>
                <th class="">Slide Gambar</th>
                <th class=""></th>
              </tr>
            </thead>
          </table>
...
<script>
  $("#table").DataTable({
    ...
    columns: [
      {data: "slide_image", render: function(data, type, row, meta) {
        return `
